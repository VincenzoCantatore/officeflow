...
public interface BookingRepository extends MongoRepository<Booking, String> {
    ...
    List<Booking> findByDateAndEndHourBeforeAndStatusNot(LocalDate date, LocalTime time, BookingStatusEnum status);

    List<Booking> findByDateBeforeAndStatusNot (LocalDate date , BookingStatusEnum status);
